          ...
          <div className="contact__info" data-aos="fade-up">
            ...
            <div className="contact__info-details">
              <ul>
                ...
                <li>
                  ...
                  <p>
                    <span>Email:&nbsp;&nbsp;</span>
                    shahsyedhamzaali1999@gmail.com
                  </p>
                </li>
                <li>
                  {" "}
            ...
            <div className="contact__social">
              <p className="contact__linkedin">
                <a
                  href="https://www.linkedin.com/in/syed-hamza-ali-shah-057930218/"
              ...
              <p className="contact__github">
                <a
                  href="https://github.com/hamzaali1999"
                  rel="noopener noreferrer"
                  target="_blank"
                >
